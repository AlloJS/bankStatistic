<?php
    ...
    require_once(ROOT . "/controller/addUsciteController.php"); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <form method="post" name="addAddebito" class="m-4 text-center">
        ...
        <div class="input-group mt-3">
            <input name="dataAddebito" class="form-control form-control-lg" type="date" placeholder=".form-control-lg" aria-label=".form-control-lg example">
        </div>

        <div class="input-group mt-3">
            <span class="input-group-text">Descrizione uscita</span>
            <textarea name="descrizioneAddebito" class="form-control" aria-label="With textarea"></textarea>
        </div>
        <button onclick="checkFormAddebito()" type="button" class="btn btn-outline-success mt-3">Aggiungi</button>
    </form>

    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-I7E8VVD/ismYTF4hNIPjVp/Zjvgyol6VFvRkX/vR+Vc4jQkC+hVqc2pM8ODewa9r" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js" integrity="sha384-0pUGZvbkm6XF6gxjEnlmuGrJXVbNuzT9qBBavbLwCsOGabYfZo0T0to5eqruptLy" crossorigin="anonymous"></script>
    <script src="<?php echo PATH ?>/public/js/addUscite.js?ts=<?=time()?>&quot"></script>
</body>
</html>