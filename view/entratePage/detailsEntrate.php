<?php
    ...
    require_once(ROOT . "/controller/detailsEntrateController.php"); 
?>
<!DOCTYPE html>
<html lang="it">
<head>
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center mb-3">
        <a href="<?php echo PATH . '/view/entratePage/detailsEntrate.php' ?>" id="btnFiltroImporto" class="btn btn-outline-primary">Ricarica</a>
        <h4 class="m-2 text-success text-center">Totale importo uscite:<br> <?php echo $total ?> €</h4>
    </div>
        <table class="table">
            <thead>
                <tr>
    ...
    <script src="<?php echo PATH ?>/public/js/detailsEntrate.js?ts=<?=time()?>&quot"></script>
</body>
</html>