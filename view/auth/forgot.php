<?php
    ...
    require_once(ROOT . "/controller/auth/forgotController.php"); 
?>
...
<body class="">
    ...
    <form name="forgot" class="container text-center mt-3 p-5" method="post" action="">
        ...
        <h2 class='text-danger'>Forgot form</h2>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Email address</label>
            <input name="email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
        </div>
        <button type="submit" id="submitForgot" class="btn btn-primary">Send</button>
        <h3 class="text-success mt-3"><?php echo $stringError; ?></h3>
        <a class='p-2' href="<?php echo PATH . '/view/auth/login.php' ?>">Or login</a>
    </form>
